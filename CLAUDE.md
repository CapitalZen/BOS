...
- **Schwartz_Breakthrough_Advertising.md** — Le socle théorique : on ne crée jamais le désir, on le canalise ; les 3 dimensions d'un désir de masse, les 5 niveaux de conscience et les 5 stades de sophistication en version complète, le rôle réel d'un titre, les techniques d'intensification.
...
- **Ecom_Funnel_Architecture.md** — Ce qui se passe après le clic : la congruence créative → funnel, les trois mécaniques biologiques d'un hook, le parcours émotionnel (Primal → Awareness → Interest → Desire → Action), l'advertorial et ses 5 formats, la landing page (above the fold, carrousel, réassurance), et les 7 mécaniques d'offre avec les 3 niveaux. Référence des skills `funnel` et `offer` en e-commerce. Contient une section « Réserves ».

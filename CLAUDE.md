...
- **Ecom_Funnel_Architecture.md** — Ce qui se passe après le clic : la congruence créative → funnel, les trois mécaniques biologiques d'un hook, **le copywriting (parler pas écrire, les 3 checks visualisable/falsifiable/unique, faits vs opinions, autorité en 3 niveaux et 10 leviers)**, le parcours émotionnel (Primal → Awareness → Interest → Desire → Action), l'advertorial et ses 5 formats, la landing page (above the fold, carrousel, réassurance), et les 7 mécaniques d'offre avec les 3 niveaux. Référence des skills `funnel` et `offer` en e-commerce. Contient une section « Réserves ».

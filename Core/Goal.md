...
Avec un panier moyen cible de 60 € :

| Objectif mensuel | Commandes / mois | Commandes / jour |
|---|---|---|
| 1 000 € | ~17 | ~0,6 |
| 3 000 € | ~50 | ~1,7 |

**Moins de deux ventes par jour.** C'est un objectif modeste et atteignable — pas un pari. Ce qui le rend atteignable n'est pas la difficulté commerciale, c'est la régularité sur cinq mois.
...
- **Trésorerie de départ :** quasi nulle. Coût de démarrage ramené à ~30-50 € le premier mois (voir `Core/Business.md`)
